...
# Dataset 1
raw_csv_1 = np.array(pd.read_csv("Wind Spatio-Temporal Dataset2.csv"))

train_ratio = 0.6
valid_ratio = 0.2

cor_wt = raw_csv_1[0:2,1:]
...
WP_len = len(WP_120_power)
data = WP_120_power[:int(WP_len*train_ratio)]
n_clusters = 4
data_T = data.T
